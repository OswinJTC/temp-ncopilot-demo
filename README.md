...
基於這個設計理念，後續的開發可以按照 docs 裡 md 的步驟進行：[有關後續開發～點我](https://gitlab.smart-aging.tech/ds/infrastructure/jubo-nis-llm-data-interface/-/blob/add-official-auth/docs/DEVELOPMENT_GUIDELINES.md)
